...
static constexpr auto qt_meta_stringdata_ZN12ExampleClassE = QtMocHelpers::stringData(
    "ExampleClass",
    "readyToSay",
    "",
    "sayHelloSlot"
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ExampleClassE[] = {
...
Q_CONSTINIT const QMetaObject ExampleClass::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ExampleClassE.offsetsAndSizes,
    qt_meta_data_ZN12ExampleClassE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ExampleClassE_t,
        // Q_OBJECT / Q_GADGET
...
void ExampleClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ExampleClass::*)();
            if (_q_method_type _q_method = &ExampleClass::readyToSay; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ExampleClass::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ExampleClassE.stringdata0))
